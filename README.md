...
- Node.js **22.12+** (LTS line; repo pins **22.14** in **`.nvmrc`**, CI, and Coolify `NODE_VERSION`)
...
Production is **Coolify** (not Render). See [`docs/deploy-coolify.md`](./docs/deploy-coolify.md).
